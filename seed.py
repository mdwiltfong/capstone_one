...
t1=Teacher(city="Detroit",state="MI",account_id="acct_1KTzulDEIfAFUi70",account_status="complete",email='wiltfong.michael1@gmail.com', username='mdwiltfong', password=password)
t2=Teacher(city="Detroit",state="MI",account_id="acct_1KVKk3RVajsjiwfo",account_status="complete",email='dubuc.andrea@gmail.com', username='lemon_bunny', password=password)
